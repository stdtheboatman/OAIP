...
public:
    ...
    QLabel *label;
    QPushButton *solveExpressionButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(100, 120, 231, 161));
        ...
        solveExpressionButton = new QPushButton(gridLayoutWidget);
        solveExpressionButton->setObjectName(QString::fromUtf8("solveExpressionButton"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(solveExpressionButton->sizePolicy().hasHeightForWidth());
        solveExpressionButton->setSizePolicy(sizePolicy);

        gridLayout->addWidget(solveExpressionButton, 2, 0, 1, 1);

        expressionInput = new QLineEdit(gridLayoutWidget);
        expressionInput->setObjectName(QString::fromUtf8("expressionInput"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(expressionInput->sizePolicy().hasHeightForWidth());
        expressionInput->setSizePolicy(sizePolicy1);

        gridLayout->addWidget(expressionInput, 1, 0, 1, 1);

        gridLayoutWidget_2 = new QWidget(centralwidget);
        gridLayoutWidget_2->setObjectName(QString::fromUtf8("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(550, 30, 160, 111));
        ...
        sizePolicy2.setHeightForWidth(expressionPostfixOutput->sizePolicy().hasHeightForWidth());
        expressionPostfixOutput->setSizePolicy(sizePolicy2);
